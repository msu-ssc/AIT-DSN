...
def main(args):
    ...
    incoming = Path("tests/cfdp/datasink/incoming")
    outgoing = Path("tests/cfdp/datasink/outgoing")
    pdusink = Path("tests/cfdp/datasink/pdusink")
    tempfiles = Path("tests/cfdp/datasink/tempfiles")
